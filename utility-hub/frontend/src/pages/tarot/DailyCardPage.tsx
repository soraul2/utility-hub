...
const DailyCardPage: React.FC = () => {
      ...
      return (
            <div className="relative min-h-screen overflow-hidden">
                  ...
                  {/* Floating Particles - Pure CSS Decoration */}
                  <div className="absolute inset-0 pointer-events-none overflow-hidden">
                        {[...Array(6)].map((_, i) => (
                              <div
                                    key={i}
                                    className="absolute bg-white/10 rounded-full blur-xl animate-mystic-float"
                                    style={{
                  ...
                  <div className="relative z-10 flex flex-col items-center justify-start min-h-[80vh] space-y-2 pt-0 pb-4 px-4 animate-fade-in-up">
                        <div className="text-center space-y-4">
                              <div className="space-y-2">
                                    <h1 className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-200 via-blue-100 to-purple-200 font-chakra tracking-tighter drop-shadow-sm">
                                          오늘의 카드
                                    </h1>
                        ...
                        <div className={`w-full max-w-6xl flex flex-col items-center justify-center relative gap-6 transition-all duration-700 ${step === 'selection' ? 'min-h-[500px] -mt-32' : '-mt-16'}`}>
                              {/* SELECTION STEP: Slot + Deck Display */}
                              {step === 'selection' ? (
                                    <>
                                          {/* Destiny Slot - Similar to 3-Card Slots */}
                                          <div className="w-48 h-72 md:w-56 md:h-80 relative group perspective-1000">
                                                {/* Empty Slot Placeholder */}
                                                <div className={`absolute inset-0 rounded-xl border-2 border-dashed border-purple-500/20 flex flex-col items-center justify-center transition-all duration-500 ${selectedCardIndex !== null ? 'opacity-0 scale-95' : 'opacity-100 scale-100'}`}>
                                                      <span className="text-purple-500/30 text-5xl mb-4 font-light">+</span>
                                                      <span className="text-purple-400/40 text-[10px] tracking-[0.3em] uppercase font-chakra">Daily Destiny</span>
                                                </div>

                                                {/* Slamming Card Animation */}
                                                {selectedCardIndex !== null && (
                                                      <div
                                                            className="absolute inset-0 animate-slam-in z-20 cursor-pointer group/slotted hover:scale-105 transition-transform"
                                                            onClick={handleCardDeselect}
                                                      >
                                                            <TarotCardView isFaceDown={true} className="w-full h-full shadow-[0_0_50px_rgba(168,85,247,0.5)] rounded-xl" />
                                                            {/* Deselect Hint */}
                                                            ...
                                                            {/* Aura Effect */}
                                                            <div className="absolute -inset-4 bg-purple-500/20 blur-2xl rounded-full animate-pulse z-[-1]" />
                                                      </div>
                                                )}
                                          </div>

                                          {/* Confirm Button */}
                                          <div className={`transition-all duration-500 transform ${selectedCardIndex !== null ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4 pointer-events-none'}`}>
                                                <button
                                                      onClick={handleConfirm}
                                                      className="flex items-center justify-center px-16 py-4 bg-gradient-to-r from-purple-900/40 via-purple-600/40 to-purple-900/40 border border-purple-400/30 rounded-full text-purple-100 font-chakra transition-all shadow-lg active:scale-95 group min-w-[320px] relative overflow-hidden"
                                                >
                                                      {/* The only non-absolute child so it centers perfectly */}
                                                      <span className="relative z-10 tracking-[0.3em] uppercase text-center w-full">
                                                            운명 확인하기
                                                      </span>

                                                      <i className="fas fa-sparkles absolute right-10 animate-pulse text-purple-300 z-10"></i>

                                                      {/* Button Shine Effect */}
                                                      <div className="absolute inset-0 bg-gradient-to-r from-transparent via-purple-400/10 to-transparent -translate-x-full group-hover:animate-[shimmer_2s_infinite] pointer-events-none" />
                                                </button>
                                          </div>

                                          {/* Interactive Deck (Bottom) - Fixed Aura Clipping */}
                                          <div
                                                ref={sliderRef}
                                                ...
                                                className="w-full overflow-x-auto overflow-y-visible scrollbar-none pb-32 pt-24 px-4 md:px-0 cursor-grab active:cursor-grabbing select-none"
                                          >
                                                      ...
                                                      {[...Array(7)].map((_, index) => {
                                                            ...
                                                            return (
                                                                  ...
                                                                  >
                                                                        ...
                                                                        >
                                                                              <TarotCardView isFaceDown={true} className="w-full h-full shadow-2xl rounded-xl border border-purple-500/20" />
                                                                              ...
                                                                              <div className="absolute -inset-16 opacity-0 group-hover:opacity-100 transition-all duration-700 pointer-events-none">
                                                                                    ...
                                                                                    <div className="absolute inset-8 bg-purple-500/20 blur-2xl animate-pulse" style={{ animationDelay: '0.5s' }} />
                                                                              </div>
                                                                        </div>
                                                                  </div>
                                                            );
                  ...
                  {showConfirmModal && (
                        <div className="fixed inset-0 z-[100] flex items-center justify-center px-4 overflow-hidden">
                              ...
                              {/* Modal Content */}
                              <div className="relative w-full max-w-lg bg-[#0d0d15]/90 border border-purple-500/30 rounded-2xl p-8 md:p-12 shadow-[0_0_100px_rgba(168,85,247,0.2)] animate-scale-in overflow-hidden">
                                    ...
                                    <div className="relative z-10 text-center space-y-8">
                                          <div className="space-y-4">
                                                <h2 className="text-2xl md:text-3xl font-chakra text-purple-100 tracking-[0.2em] font-bold uppercase">
                                                      선택을 확정하시겠습니까?
                                                </h2>
                                                <div className="w-16 h-[1px] bg-purple-500/50 mx-auto" />
                                          </div>
                                          ...
                                          <div className="flex flex-col md:flex-row gap-4 pt-4">
                                                ...
                                                <button
                                                      ...
                                                      className="flex-1 px-8 py-4 rounded-xl bg-gradient-to-r from-purple-900 to-purple-700 text-white font-chakra text-sm uppercase tracking-[0.2em] font-bold shadow-[0_0_20px_rgba(168,85,247,0.3)] hover:shadow-[0_0_30px_rgba(168,85,247,0.5)] transition-all animate-pulse-slow"
                                                >
                                                      네, 확인하겠습니다
                                                </button>
                                          </div>
                                    ...
                                    {/* Decorative Patterns */}
                                    <div className="absolute top-4 left-4 w-8 h-8 border-t border-l border-purple-500/20" />
                                    <div className="absolute top-4 right-4 w-8 h-8 border-t border-r border-purple-500/20" />
                                    <div className="absolute bottom-4 left-4 w-8 h-8 border-b border-l border-purple-500/20" />
                                    <div className="absolute bottom-4 right-4 w-8 h-8 border-b border-r border-purple-500/20" />
                              </div>
                        </div>
                  )}
            </div>
